...
source /opt/app/CloudProject/env/bin/activate
/opt/app/gce/env/bin/pip install -r /opt/app/CloudProject/requirements.txt

# Set ownership to newly created account
chown -R pythonapp:pythonapp /opt/app

# Put supervisor configuration in proper place
cp /opt/app/CloudProject/python-app.conf /etc/supervisor/conf.d/python-app.conf
